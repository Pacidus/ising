...
class lattice:
    ...
    Parameters:
        ...
        all: 1 or -1
            set the state at all 1 or -1 overpass the r parrameter

        r: float in [0, 1]
            set a random state with a ratio r of 1 in the lattice
            (default r = 0.5)

        adj: np.array 
            a vector of vector: is the representation of the spin interaction
            010
            1#1 will be written as [[1,0],[-1,0],[0,1],[0,-1]]
            010
        ...
        J: np.array or float
            ...
            if J is an array he as to be the same length than adj (you can choose to make anisotropic iteractions !!)
